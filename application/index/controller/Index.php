...
class Index extends Base
{
    public function index($userId)
    {
        //测试
        $userInfo['status']=1;
        $userInfo['shop_name']="124567";
        $userInfo['address']="address";
        $authGroupAccess['group_id']=2;
        $brandLists=array(array("id"=>"1","brand_logo"=>"https://image.sudian178.com/sd/index/theme/3144594489317689.jpg"),
            array("id"=>"2","brand_logo"=>"https://image.sudian178.com/sd/index/theme/3144594489317689.jpg"),
            array("id"=>"3","brand_logo"=>"https://image.sudian178.com/sd/index/theme/3144594489317689.jpg"));
    ...
    public function show($userId, $typeId, $varId)
    {
        ...
        //测试
        $current["var_name"]="品种名称";
        $current["var_template"]=array("https://image.sudian178.com/sd/index/theme/3144594489317689.jpg","https://image.sudian178.com/sd/index/theme/3144594489317689.jpg");
        $this->assign('orderNum', 100);
        $this->assign('current', $current);
        $this->assign('phoneTypeName', "iphone");
        $this->assign('phoneTypeNameId', "iphone111");
        $this->assign('phoneVarietiesName', "品种名称");
        $this->assign('phoneVarietiesNameId', "品种名称");
        $this->assign('varTypeName', "手机壳");
        $this->assign('varTypeNameId', "手机彩膜");
    ...
    {
        //测试
        $typeLists=array(array("id"=>"1","brand_id"=>"1","type_name"=>"iphone6s"),
            array("id"=>"2","brand_id"=>"2","type_name"=>"iphone7"),
            array("id"=>"3","brand_id"=>"3","type_name"=>"iphone8s"));
        return array(
            'code'=>1,
            'msg'=>'ok',
            'data'=>$typeLists
    ...
    public function ajaxGetPhoneVarieties($id)
    {
        ...
        //测试
        $typeLists=array(array("status"=>1,"type_id"=>$id,"var_name"=>"iphone6s"),
            array("status"=>1,"type_id"=>$id,"var_name"=>"iphone7"),
            array("status"=>1,"type_id"=>$id,"var_name"=>"iphone8s"));
        return array(
            'code'=>1,
            'msg'=>'ok',
            'data'=>$typeLists
    ...
    {
        //测试
        $typeLists=array(array("status"=>1,"id"=>"1","cate_name"=>"蒙版1"),
            array("status"=>1,"id"=>"2","cate_name"=>"蒙版2"),
            array("status"=>1,"id"=>"3","cate_name"=>"蒙版3"));
        return array(
            'code'=>1,
            'msg'=>'ok',
            'data'=>$typeLists
    ...
    {
        //测试
        $typeLists=array(array("cate_id"=>$id,"id"=>"1","pic_path"=>"https://image.sudian178.com/sd/index/theme/3144594489317689.jpg"),
            array("cate_id"=>$id,"id"=>"2","pic_path"=>"https://image.sudian178.com/sd/index/theme/3144594489317689.jpg"),
            array("cate_id"=>$id,"id"=>"3","pic_path"=>"https://image.sudian178.com/sd/index/theme/3144594489317689.jpg"));
        return array(
            'code'=>1,
            'msg'=>'ok',
            'data'=>$typeLists
    ...
    public function ajaxGetChartCategorys()
    {
        ...
        //测试
        $typeLists=array(array("status"=>1,"id"=>"1","cate_name"=>"贴图1"),
            array("status"=>1,"id"=>"2","cate_name"=>"贴图2"),
            array("status"=>1,"id"=>"3","cate_name"=>"贴图3"));
        return array(
            'code'=>1,
            'msg'=>'ok',
            'data'=>$typeLists
    ...
    public function ajaxGetChartCategoryPicturesById($id)
    {
        ...
        //测试
        $typeLists=array(array("cate_id"=>$id,"id"=>"1","pic_path"=>"https://21go.oss-cn-hangzhou.aliyuncs.com/stress/image/heard/20200731155137219292.jpg"),
            array("cate_id"=>$id,"id"=>"2","pic_path"=>"https://21go.oss-cn-hangzhou.aliyuncs.com/stress/image/heard/20200731155137219292.jpg"),
            array("cate_id"=>$id,"id"=>"3","pic_path"=>"https://21go.oss-cn-hangzhou.aliyuncs.com/stress/image/heard/20200731155137219292.jpg"));
        return array(
            'code'=>1,
            'msg'=>'ok',
            'data'=>$typeLists
